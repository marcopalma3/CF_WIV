...
#Sorted setting environmental variable from control panel R_LIBS_USER and move StanHeaders to personal library
#or change it on terminal $ R_LIBS_USER="H:/Documents/R/Library/" R_LIBS_USER="H:/Documents/R/win-library/4.1"
# myPaths <- .libPaths()   #https://www.accelebrate.com/library/how-to-articles/r-rstudio-library
# myPaths <- normalizePath(c(myPaths[2], myPaths[1]), winslash = "/")
# .libPaths(myPaths)

###RUN .libPaths("H:/Documents/R/win-library/4.1") in the console before knitting
...
cfdata <- read.csv("Q:/cysticfibrosis/data/CFT_EpiNet2020_master_v3_5July2022.csv"
    #, col_types = cols(v_date = col_date(format = "%d/%m/%Y"))
